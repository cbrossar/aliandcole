...
export default function Travel() {
  return (
    <div className="w-full min-h-screen">
      ...
      {/* Main Content Area */}
      <div className="flex-1 px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16" style={{ backgroundColor: "rgb(248, 245, 239)" }}>
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-6 sm:mb-8 font-['Alice',serif] text-center text-gray-800">Where to Stay</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center bg-white rounded-xl shadow-sm p-4 sm:p-6 hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl sm:text-2xl font-serif mb-3 sm:mb-4 text-gray-800">Çırağan Palace Kempinski</h3>
            ...
            <div className="flex flex-col items-center text-center bg-white rounded-xl shadow-sm p-4 sm:p-6 hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl sm:text-2xl font-serif mb-3 sm:mb-4 text-gray-800">The Stay</h3>
              <p className="text-sm sm:text-sm text-left mb-4 sm:mb-6 text-gray-600 leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center bg-white rounded-xl shadow-sm p-4 sm:p-6 hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl sm:text-2xl font-serif mb-3 sm:mb-4 text-gray-800">Swissôtel The Bosphorus</h3>
              <p className="text-sm sm:text-sm text-left mb-4 sm:mb-6 text-gray-600 leading-relaxed">
